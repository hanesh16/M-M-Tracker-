            ...
            <div className="col-lg-5">
              <div className="balance-card balance-milky" style={{
                ...
                <div style={{
                  ...
                  <img src={require('../images/pic8.png')} alt="Milky" style={{ maxHeight: '80px', maxWidth: '100%', objectFit: 'contain' }} />
                </div>
              ...
              <div className="flip-card" style={{ height: '220px' }}>
                <div className="flip-card-inner">
                  <div className="flip-card-front">
                    <img src={require('../images/pic6.png')} alt="Balance" style={{ maxHeight: '200px', maxWidth: '100%', objectFit: 'contain' }} />
                  </div>
            ...
            <div className="col-lg-5">
              <div className="balance-card balance-mocha" style={{
                ...
                <div style={{
                  ...
                  <img src={require('../images/pic7.png')} alt="Mocha" style={{ maxHeight: '80px', maxWidth: '100%', objectFit: 'contain' }} />
                </div>
