...
class ExpenseBase(BaseModel):
    ...
    currency: str = "USD"  # Currency user had selected when entering this expense
...
class IncomeBase(BaseModel):
    ...
    income_date: date
    notes: Optional[str] = None
    currency: str = "USD"  # Currency user had selected when entering this income
